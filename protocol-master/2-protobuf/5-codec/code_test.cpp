 ...
 * @LastEditTime: 2023-06-09 22:08:38
 */
#include <iostream>
#include <stdio.h>
#include <unistd.h>
...
void Tint32()
{
    ...
    int32_t int1Size = int1.ByteSize(); // 序列化后的大小
...
void Tint64()
{
    ...
    int32_t n1Size = n1.ByteSize(); // 序列化后的大小
...
void Tstring(void)
{
    ...
    int32_t str1Size = n1.ByteSize(); // 序列化后的大小
...
void TRepeatedfields(void)
{
    ...
    bytes->set_n1("darren-12");
    bytes = n1.add_n2();
    bytes->set_n1("darren-34");
    bytes = n1.add_n2();
    bytes->set_n1("darren-56");
...
void THasitem(void)
{
    ...
    int32_t n1Size = hasitem.ByteSize(); // 序列化后的大小
