...
void handle_login_request(CImPdu* pPdu) 
{
	...
	if(login.has_int32_1()) {
		std::cout << "oneof int32_1: " << login.int32_1() << std::endl;
	}
	if(login.has_string_2()) {
		std::cout << "oneof string_2: " << login.string_2() << std::endl;
	}

	if(login.has_musicresponse()) {
		cout<<"\nmusic response:"<<endl;
		cout<<"author: "<<login.musicresponse().author()<<endl;
		cout<<"title: "<<login.musicresponse().title()<<endl;
		cout<<"data: "<<login.musicresponse().data()<<endl;
	}
	if(login.has_articleresponse()) {
		cout<<"\narticle response:"<<endl;
		cout<<"author: "<<login.articleresponse().author()<<endl;
		cout<<"title: "<<login.articleresponse().title()<<endl;
		cout<<"date: "<<login.articleresponse().date()<<endl;
	}
}
