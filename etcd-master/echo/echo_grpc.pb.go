...
type EchoClient interface {
	...
	UnaryLock(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoLockResponse, error)
}
...
func (c *echoClient) UnaryLock(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoLockResponse, error) {
	out := new(EchoLockResponse)
	err := c.cc.Invoke(ctx, "/echo.Echo/UnaryLock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EchoServer interface {
	...
	UnaryLock(context.Context, *EchoRequest) (*EchoLockResponse, error)
...
func (UnimplementedEchoServer) UnaryLock(context.Context, *EchoRequest) (*EchoLockResponse, error) {
...
func _Echo_UnaryLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EchoServer).UnaryLock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/echo.Echo/UnaryLock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServer).UnaryLock(ctx, req.(*EchoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Echo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnaryLock",
			Handler:    _Echo_UnaryLock_Handler,
		},
	},
